...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!csrf_check($_POST['_csrf'] ?? null)) {
        ...
        try {
            ...
            redirect('/admin/promociones.php?saved=' . ($action === 'edit' ? 'updated' : 'created'));
        } catch (Throwable $e) {
...
<div class="promo-toolbar">
  ...
  <div class="toolbar-actions"><?=action_button('Nueva promoción','/admin/promociones.php?action=create','btn')?> <a class="btn btn-secondary" href="/api/promociones.php?channel=web" target="_blank" rel="noopener">Ver feed web</a></div>
</div>
<?php if($error): ?><div class="notice danger promo-notice"><?=e($error)?></div><?php endif; ?>
...
<td><div class="promo-chips"><?php if((int)$r['show_web']===1): ?><span>Web</span><?php endif; ?><?php if((int)$r['show_catalog']===1): ?><span>Catálogo</span><?php endif; ?><?php if((int)$r['show_whatsapp']===1): ?><span>WhatsApp</span><?php endif; ?></div></td>
